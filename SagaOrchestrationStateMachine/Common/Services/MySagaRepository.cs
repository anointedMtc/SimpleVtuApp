...
namespace SagaOrchestrationStateMachines.Common.Services;

public sealed class MySagaRepository<T> : IRepository<T> where T : class, IAggregateRoot
{
    private readonly SagaStateMachineDbContext _sagaStateMachineDbContext;

    public MySagaRepository(SagaStateMachineDbContext sagaStateMachineDbContext)
    {
