...
public static class CacheHelperSagas
{
    ...
    private static readonly string _getAllUserCreatedSagaKeyTemplate = "saga-{0}-{1}-{2}-{3}";
    private static readonly string _getAllVtuAirtimeSagaKeyTemplate = "saga-{0}-{1}-{2}-{3}";
    private static readonly string _getAllVtuDataSagaKeyTemplate = "saga-{0}-{1}-{2}-{3}";
